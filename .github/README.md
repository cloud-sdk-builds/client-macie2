...
[`@aws-sdk/client-macie2`](https://www.npmjs.com/package/@aws-sdk/client-macie2/v/3.797.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-macie2@3.797.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-90dhMyG2M2OYTGad4PuRhpp1TMv1alsNzsth+DEpZYgObGc3tkV3dkElAojzzTPT
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-macie2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-macie2@3.797.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-macie2@3.797.0/index.min.mjs": "sha384-90dhMyG2M2OYTGad4PuRhpp1TMv1alsNzsth+DEpZYgObGc3tkV3dkElAojzzTPT"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-macie2/blob/refs/tags/3.797.0/LICENSE
```
