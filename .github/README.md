...
[`@aws-sdk/client-macie2`](https://www.npmjs.com/package/@aws-sdk/client-macie2/v/3.576.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-macie2@3.576.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-PqKFb9RMsivegvOFCP0/dnm+UnF1mt/86DSuducSqg1gbt5JKl5pNnn4/C/kCBGs
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-macie2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-macie2@3.576.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-macie2@3.576.0/index.min.mjs": "sha384-PqKFb9RMsivegvOFCP0/dnm+UnF1mt/86DSuducSqg1gbt5JKl5pNnn4/C/kCBGs"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-macie2/blob/refs/tags/3.576.0/LICENSE
```
