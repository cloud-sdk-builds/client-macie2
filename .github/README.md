...
[`@aws-sdk/client-macie2`](https://www.npmjs.com/package/@aws-sdk/client-macie2/v/3.968.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-macie2@3.968.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+QTdS+/vqlobcaFIoH9hZH1ULyx+lawoG5RX8Erc53esqWFcNWYPlx+hKMNe8mpY
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-macie2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-macie2@3.968.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-macie2@3.968.0/index.min.mjs": "sha384-+QTdS+/vqlobcaFIoH9hZH1ULyx+lawoG5RX8Erc53esqWFcNWYPlx+hKMNe8mpY"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-macie2/blob/refs/tags/3.968.0/LICENSE
```
